...
class FoodPackagingConstraintProviderTest {
    ...
    @Disabled
    void maxEndDateTime() {
        Job job1 = new Job("1", "job1", PRODUCT_A_SMALL, Duration.ofMinutes(6000),
                null, null, null, 1, false, null, null);

        Job job2 = new Job("2", "job2", PRODUCT_A_SMALL, Duration.ofMinutes(200),
                null, null, DAY_START_TIME.plusMinutes(200), 1, false,
                DAY_START_TIME, DAY_START_TIME);

        Job job3 = new Job("3", "job3", PRODUCT_A_SMALL, Duration.ofMinutes(150),
                null, null, DAY_START_TIME.plusMinutes(100), 1, false,
                DAY_START_TIME, DAY_START_TIME);
    ...
    void idealEndDateTime() {
        ...
        Job job2 = new Job("2", "job2", PRODUCT_A_SMALL, Duration.ofMinutes(200),
                null, DAY_START_TIME.plusMinutes(200), null, 1, false,
                DAY_START_TIME, DAY_START_TIME);

        Job job3 = new Job("3", "job3", PRODUCT_A_SMALL, Duration.ofMinutes(150),
                null, DAY_START_TIME.plusMinutes(100), null, 1, false,
                DAY_START_TIME, DAY_START_TIME);
    ...
    void minimizeMakespan() {
        ...
        Job job2 = new Job("2", "job2", PRODUCT_A_SMALL, Duration.ofMinutes(100),
                null, null, null, 1, false,
                DAY_START_TIME, DAY_START_TIME);

        Job job3 = new Job("3", "job3", PRODUCT_A_SMALL, Duration.ofMinutes(200),
                null, null, null, 3, false,
                DAY_START_TIME, DAY_START_TIME);

        Job job4 = new Job("4", "job4", PRODUCT_A_SMALL, Duration.ofMinutes(1000),
                null, null, null, 3, false,
    ...
    void minimizeCleaningDuration() {
        Job job1 = new Job("1", "job1", PRODUCT_A_SMALL, Duration.ofMinutes(6000),
                DAY_START_TIME, null, null, 1, false, null, null);

        Job job2 = new Job("2", "job2", PRODUCT_A_SMALL, Duration.ofMinutes(200),
                DAY_START_TIME, null, null, 1, false,
                DAY_START_TIME, DAY_START_TIME);
